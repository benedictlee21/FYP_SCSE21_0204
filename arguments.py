...
class Arguments:
    def __init__(self, stage='pretrain'):
        ...
        if stage == 'eval_completion':
            ...
            if stage == 'pretrain':
                ...
                print('ShapeInversion mode.')
                self.add_inversion_args()

            elif stage == 'eval_treegan':
                print('Evaluation of TreeGAN.')
    ...
    def add_common_args(self):
        ...
        self._parser.add_argument('--conditional_gan', type=bool, default=False, help='use conditional gan for multiclass')
