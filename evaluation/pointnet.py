...
class PointNetCls(nn.Module):
    ...
    def forward(self, x):
        ...
        # x (B, 3, 2048), trans (B, 3, 3) actv (B,1808) x4 (B, 16)
        # TODO to verify: F.log_softmax(x4, dim=0)[0] 
        # [-4.5901, -4.9433, -4.6607, -4.2243, -4.5989, -4.8896, -4.7348, -4.8092,
        # -4.7989, -4.3984, -4.6247, -4.8800, -4.6084, -4.4440, -4.6100, -5.0105]
