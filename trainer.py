...
class Trainer(object):
        ...
        for i, data in enumerate(self.dataloader):
            ...
            if self.args.visualize:
                ...
                if self.args.inversion_mode == 'jittering':
                    ...
                    draw_any_set(flag_list, pcd_list, output_dir, output_stem, layout=(5,10))
                else:
                    output_stem = str(index.item())
                    # original layout=(4,4)
    ...
    def train_diversity(self):
        for i, data in enumerate(self.dataloader):
            ...
            flag_ls = ['Ground Truth', 'Input Partial Shape']
    ...
    def train_morphing(self):
        ...
        for i, data in enumerate(self.dataloader):
            ...
            if self.args.visualize:
                ...
                flag_ls = ['Ground Truth 1'] + interpolated_flag + ['Ground Truth 2']
                output_dir = self.args.save_inversion_path + '_visual'
